...
- Build cache keys include task implementation, task action implementations, output property names, and input names/values. Task names and project paths do not by themselves make outputs different.
