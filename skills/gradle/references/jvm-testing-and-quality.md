...
- For TestNG `threadPoolFactoryClass`, implementations used with TestNG 7.10+ must implement `org.testng.IExecutorServiceFactory`; TestNG 7.0 through 7.9 requires `org.testng.thread.IExecutorFactory`.
